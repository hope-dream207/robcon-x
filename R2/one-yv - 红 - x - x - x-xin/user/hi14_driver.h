/**
  ...
  * @details
  *   功能:
  *     - HI14 传感器初始化 (Modbus 层初始化 + DMA/IDLE 接收)
  *     - 自动水平校准 (当前 Roll/Pitch 归零)
  *     - 批量读取传感器数据 (加速度 / 角速度 / 欧拉角 / 温度)
  *     - 一阶低通滤波 (减少麦轮底盘振动引入的高频噪声)
  *     - 航向锁定 (Heading Lock) 角速度修正量计算
  *     - 急停检测 (Roll 或 Pitch 超过 ±25°)
  *
  *   硬件:
