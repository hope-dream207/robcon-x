...
#define GO_M8010_6_GEAR_RATIO 6.33f
...
typedef struct
{
    ...
    float vel_error;        // 速度误差
    float torque_error;     // 力矩误差
...
typedef MotorCmd_t MotorCmd;
typedef MotorData_t MotorData;
...
// Get pointer to send data buffer
static inline uint8_t *MotorCmd_get_motor_send_data(MotorCmd_t *motor_s)
{
    return (uint8_t *)&motor_s->motor_send_data;
}
