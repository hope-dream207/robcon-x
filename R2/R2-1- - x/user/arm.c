...
#define ARM_O3_MIN (-13.0f)  // 关节2最小角度 rad
...
void arm_change()
    ...
    {//关节侧弧度，Unitree_SetMotor内部会 ×6.33 转为电机侧
        ...
        case get_put://-11.00;13.5;-7.425（换点前）
            ...
            ARM_to.o3 = -3.7f;
            break;
        case arm_put://-8.37 10.54 -11.8//-8.0,10.10
            ARM_to.o1 = -8.37f;
            ARM_to.o2 = 10.54f;
            ARM_to.o3 = -11.8f;
            break;
...
float start_o2 = 0.0f;
float start_o3 = 0.0f;
float target_o1 = 0.0f;
float target_o2 = 0.0f;
float target_o3 = 0.0f;
...
void arm_final()
{
...

    {
        ...
        {
            const float transition_ms = 1200.0f;// 过渡时间（毫秒）
            const float transition_ms_set1 = 1000.0f;// 过渡时间（毫秒）大轴
